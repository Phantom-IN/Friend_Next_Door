...
Command: npx gltfjsx@6.2.10 .\girl.glb 
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/assets/3d_models/girl.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature">
          ...
          <skinnedMesh name="Wolf3D_Outfit_Top" geometry={nodes.Wolf3D_Outfit_Top.geometry} material={materials['Wolf3D_Outfit_Top.004']} skeleton={nodes.Wolf3D_Outfit_Top.skeleton} />
          ...
          <skinnedMesh name="Wolf3D_Head" geometry={nodes.Wolf3D_Head.geometry} material={materials['Wolf3D_Skin.004']} skeleton={nodes.Wolf3D_Head.skeleton} morphTargetDictionary={nodes.Wolf3D_Head.morphTargetDictionary} morphTargetInfluences={nodes.Wolf3D_Head.morphTargetInfluences} />
...
useGLTF.preload('/assets/3d_models/girl.glb')